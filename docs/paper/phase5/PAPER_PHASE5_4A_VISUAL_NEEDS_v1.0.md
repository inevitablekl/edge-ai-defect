...
Purpose: show the common E2E path, the broader V0→V2R intervention, and the narrower V2R→V3R intervention. The figure should distinguish conceptual stage composition from measured quantities and must not imply that stages were independently timed, that Amdahl parameters were fitted, or that the interventions form a causal decomposition.
...
Phase 5.4C must derive final cell content from implementation authority and manuscript semantics. This specification does not authorize final wording or a new publication table.
