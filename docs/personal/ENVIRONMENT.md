...
| 环境 | 用途 | 当前状态 |
|---|---|---|
| Local Development PC | 代码开发、C++ 编译、本地 ONNX Runtime 初步验证 | 已知部分信息 |
...
正式实验开始前，必须补齐 Jetson、JetPack、CUDA、TensorRT、ONNX Runtime、OpenCV 和资源监控方法等信息。
