...
REQUIRED_HEADINGS = {
    ...
    "1.1 模型、数据集与边缘部署平台": "HFUTHeading2",
    "1.2 端到端推理数据路径与受控变量": "HFUTHeading2",
    "1.3 端到端执行概念分解与优化覆盖关系": "HFUTHeading2",
    "1.4 统一计时边界与研究问题": "HFUTHeading2",
    "2 数据路径优化方法": "HFUTHeading1",
    "2.1 CPU/OpenCV基线路径": "HFUTHeading2",
    "3 实验设计": "HFUTHeading1",
